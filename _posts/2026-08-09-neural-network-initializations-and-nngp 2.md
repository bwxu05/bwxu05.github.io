...
NNGP 让随机初始化的作用变得非常直接：$\sigma_w,\sigma_b$ 和 nonlinearity $\phi$ 决定了核映射
...
这正是 He initialization 的平均场解释。

更进一步，ReLU 的 off-diagonal kernel 也有闭式解。令
